class Cfd20 < ApplicationController
	...
	require 'nokogiri'
	attr_accessible :version, :serie, :folio, :fecha, :sello, :noAprobacion, :anoAprobacion, :tipoDeComprobante, :formaDePago, :condicionesDePago, :noCertificado, :certificado, :subTotal, :descuento, :total, :metodoDePago, :NumCtaPago, :TipoCambio, :Moneda, :LugarExpedicion, :Emisor, :Receptor
